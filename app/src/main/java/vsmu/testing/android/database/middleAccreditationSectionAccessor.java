 ...
 */
public class middleAccreditationSectionAccessor {
    ...
    middleAccreditationSectionAccessor(Context context) {
        this.sectionName = "middleAccreditationSection";
        this.subjectNames = context.getResources().getStringArray(R.array.databaseFileNameAccreditationSPO);
